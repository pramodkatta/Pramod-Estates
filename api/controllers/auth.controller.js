...
export const signup = async (req, res, next) => {
    const { username, email, password} = req.body;  // to save this infomartion inside the database
...
export const signin = async (req, res, next) => {
    ...
    try{
        const validUser = await User.findOne({email: email});  //checking weather the email is regidtered or not
